...
const OrderStatistics = ({ orders, orderType, selectedDate }) => {
  ...
  return (
    ...
    <div className="order-statistics">
      ...
      <p>Total Orders on {selectedDate ? moment(selectedDate).format("MMM Do YYYY") : "All Dates"}: {totalOrders}</p>
      ...
      <div className="row">
        ...
        <div className="col-lg-4">
          ...
          <div className="card card-body mb-4 shadow-sm">
            ...
            <OrderStatistics orders={orders} orderType="all" selectedDate={selectedDate} />
        ...
        <div className="col-lg-4">
          ...
          <div className="card card-body mb-4 shadow-sm">
            ...
            <OrderStatistics orders={orders} orderType="dine-in" selectedDate={selectedDate} />
        ...
        <div className="col-lg-4">
          ...
          <div className="card card-body mb-4 shadow-sm">
            ...
            <OrderStatistics orders={orders} orderType="online" selectedDate={selectedDate} />
